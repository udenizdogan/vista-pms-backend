...
public class MaintenancePriorityConfiguration : IEntityTypeConfiguration<MaintenancePriority>
{
    public void Configure(EntityTypeBuilder<MaintenancePriority> builder)
    {
