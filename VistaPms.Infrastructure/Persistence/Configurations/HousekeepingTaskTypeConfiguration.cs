...
public class HousekeepingTaskTypeConfiguration : IEntityTypeConfiguration<HousekeepingTaskType>
{
    public void Configure(EntityTypeBuilder<HousekeepingTaskType> builder)
    {
